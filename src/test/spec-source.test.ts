...
function plan(overrides: Partial<PlanSession> = {}): PlanSession { const base = { schemaVersion: 2, id: "plan-session", stateVersion: 4, documentRevision: 1, status: "ready", source: { prompt: "Build", cwd: "/repo" }, generation: { mode: "normal" }, document: { id: "doc", title: { id: "title", kind: "title", body: "Plan", children: [] }, elements: [] }, committedMarkdown: "# Exact Plan\r\n", annotations: [], grill: { basedOnDocumentRevision: 1, annotationIds: {}, decisionTree: { nodes: [] }, generatedAt: "2026-07-12T00:00:00.000Z" } } as PlanSession; return { ...base, ...overrides } as PlanSession; }
