...
describe("prompt-build helpers", () => {
  it("resolves multiplier choices", () => {
  ...
  it("builds topic prompts that construct prompt options without solving the goal", () => {
    ...
    expect(prompt).toContain("Unstructured output is invalid");
    expect(prompt).toContain("at least three valid structured candidates");
