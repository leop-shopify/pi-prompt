...
2. **Adversarial Review** displays that same Plan revision rather than rewriting it. Generated, evidence-backed findings appear in very light red and are body-immutable, while user comments remain editable in light yellow. The review also persists a decision tree in the compatibility-named `grill.json` for the next stage.
